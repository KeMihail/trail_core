...
/**
 * This is the extension manager of the Trailpayment extension.
 */
public class TrailpaymentManager extends GeneratedTrailpaymentManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TrailpaymentManager.class);
	 ...
	 */
	public static TrailpaymentManager getInstance()
	{
		return (TrailpaymentManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TrailpaymentConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrailpaymentManager() // NOPMD 
	{
		LOG.debug("constructor of TrailpaymentManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TrailpaymentManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TrailpaymentManager called, current tenant: {}", getTenant().getTenantID());
	}
