...
public class DefaultPromotionengineService implements PromotionengineService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultPromotionengineService.class);
	...
	{
		return DefaultPromotionengineService.class.getResourceAsStream("/promotionengine/sap-hybris-platform.png");
	}
