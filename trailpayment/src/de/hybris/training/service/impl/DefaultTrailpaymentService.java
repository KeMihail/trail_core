...
public class DefaultTrailpaymentService implements TrailpaymentService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTrailpaymentService.class);
	...
	{
		return DefaultTrailpaymentService.class.getResourceAsStream("/trailpayment/sap-hybris-platform.png");
	}
