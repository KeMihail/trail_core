...
/**
 * This is the extension manager of the Promotionengine extension.
 */
public class PromotionengineManager extends GeneratedPromotionengineManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(PromotionengineManager.class);
	 ...
	 */
	public static PromotionengineManager getInstance()
	{
		return (PromotionengineManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(PromotionengineConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PromotionengineManager() // NOPMD 
	{
		LOG.debug("constructor of PromotionengineManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of PromotionengineManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of PromotionengineManager called, current tenant: {}", getTenant().getTenantID());
	}
